<template>
  <div>
    ...
    <div class="container col-7 p-3">
      ...
      <span v-if="checkpassword" style="color: red; text-align: center">Both Password should be same</span>
      <div class="d-flex justify-content-center">
        <ButtonComponent label="Update Password" class="btn--primary--sm" @onClick="changePassword()" />
      </div>
    </div>
  </div>
</template>
